/*
 * HV5523ESP327SegDriver.h
 *
 *  Created on: May 22, 2021
 *      Author: Paul Andrews
 */

#ifndef LIBRARIES_NIXIEDRIVER_HV5523ESP327SegDriver_H_
#define LIBRARIES_NIXIEDRIVER_HV5523ESP327SegDriver_H_

#include <NixieDriver.h>
#include <SPI.h>

class HV5523ESP327SegDriver : public NixieDriver {
public:
	HV5523ESP327SegDriver(int LEpin) : LEpin(LEpin) {}
	HV5523ESP327SegDriver(int LEpin, bool small) : LEpin(LEpin), small(small) {}
	~HV5523ESP327SegDriver() {}
...
private:
	...
	static HV5523ESP327SegDriver *_handler;
#ifdef ESP32
...
#endif /* LIBRARIES_NIXIEDRIVER_HV5523ESP327SegDriver_H_ */
